...
public class Receive880UpdatedKML implements javax.jms.MessageListener{
	...
	public void readFile(){
		try{
				...
				ref = ctex.lookup("queue/CCC880Queue");
	...
	public static void main(String[] args) {
		...
		Receive880UpdatedKML rv = new Receive880UpdatedKML();
		rv.readFile();
		System.out.println("CCC Freeway " + Param.WAY880 + " listener started successfully");

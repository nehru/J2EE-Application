...
public class Receive101UpdatedKML implements javax.jms.MessageListener{
	...
	public void readFile(){
		...
		System.out.println("readFile starting on message in Receive1010updatedKML file");
		try{
			...
			kDir = new File("visual");
				...
				ref = ctex.lookup("queue/CCC101Queue");
	...
	public static void main(String[] args) {
		...
		Receive101UpdatedKML rv = new Receive101UpdatedKML();
		rv.readFile();
				
		System.out.println("CCC Freeway " + Param.WAY101 + " listener started successfully");

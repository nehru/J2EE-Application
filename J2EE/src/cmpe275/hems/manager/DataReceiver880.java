...
@MessageDriven(activationConfig = {
		@ActivationConfigProperty(propertyName="destination", propertyValue="queue/DataQueue880"),
		@ActivationConfigProperty(propertyName="destinationType", propertyValue="javax.jms.Queue"),
		@ActivationConfigProperty(propertyName="acknowledgeMode", propertyValue="AUTO_ACKNOWLEDGE")
}, mappedName="queue/DataQueue880")

@EJB(name="test", beanInterface=EstimatorLocal.class)

public class DataReceiver880 implements javax.jms.MessageListener{
	@Resource 
	...
	public void onMessage(Message arg0) {
		try {
			...
			/*	if(smsData != null)
					System.out.println("880 data received");
				else
